...
export function AuthBackdrop() {
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden", pointerEvents: "none" }}>
      ...
      <span
        className="auth-blob"
        style={{ position: "absolute", bottom: "-18%", right: "6%", width: 520, height: 520, borderRadius: "50%", filter: "blur(80px)", background: "radial-gradient(circle, rgba(86, 104, 143,.18), transparent 66%)", animation: "authBlobB 19s ease-in-out infinite" }}
      />
      <span
        className="auth-blob"
